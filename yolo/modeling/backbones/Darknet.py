...
from yolo.modeling import building_blocks as nn_blocks
...
CSPDARKNET53 = {
    ...
    "backbone": [
        [
            "DarkConv", None, 1, False, 32, None, 3, 1, "same", "mish", -1, 0,
            False
        ],
        [
        ...
        [
            "DarkRes", "csp", 2, False, 128, None, None, None, None, "mish",
            -1, 2, False
        ],
        [
            "DarkRes", "csp", 8, False, 256, None, None, None, None, "mish",
            -1, 3, True
        ],
        [
            "DarkRes", "csp", 8, False, 512, None, None, None, None, "mish",
            -1, 4, True
        ],
        [
...
DARKNET53 = {
    ...
    "backbone": [
        [
            "DarkConv", None, 1, False, 32, None, 3, 1, "same", "leaky", -1, 0,
            False
        ],
        [
            "DarkRes", "residual", 1, True, 64, None, None, None, None,
            "leaky", -1, 1, False
        ],
        [
...
CSPDARKNETTINY = {
    ...
    "backbone": [
        [
            "DarkConv", None, 1, False, 32, None, 3, 2, "same", "leaky", -1, 0,
            False
        ],
        [
            "DarkConv", None, 1, False, 64, None, 3, 2, "same", "leaky", -1, 1,
            False
        ],
        [
        ...
        [
            "DarkConv", None, 1, False, 512, None, 3, 1, "same", "leaky", -1,
            5, True
        ],
    ]
}
...
DARKNETTINY = {
    ...
    "backbone": [
        [
            "DarkConv", None, 1, False, 16, None, 3, 1, "same", "leaky", -1, 0,
            False
        ],
        [
            "DarkTiny", None, 1, True, 32, None, 3, 2, "same", "leaky", -1, 1,
            False
        ],
        [
            "DarkTiny", None, 1, True, 64, None, 3, 2, "same", "leaky", -1, 2,
            False
        ],
        [
            "DarkTiny", None, 1, False, 128, None, 3, 2, "same", "leaky", -1,
            3, False
        ],
        [
            "DarkTiny", None, 1, False, 256, None, 3, 2, "same", "leaky", -1,
            4, True
        ],
        [
            "DarkTiny", None, 1, False, 512, None, 3, 2, "same", "leaky", -1,
            5, False
        ],
        [
            "DarkTiny", None, 1, False, 1024, None, 3, 1, "same", "leaky", -1,
            5, True
        ],
    ]
}
...
class Darknet(ks.Model):
    def __init__(
        ...
        if isinstance(input_specs, List) or isinstance(input_specs, Tuple):
            if len(input_specs) == 4:
                self._input_shape = tf.keras.layers.InputSpec(
                    shape=input_specs)
            else:
                self._input_shape = tf.keras.layers.InputSpec(
                    shape=[None] + list(input_specs))
        else:
